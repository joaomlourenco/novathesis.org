...
passou as mil estrelas no GitHub. Mil e uma, à hora a que isto se escreve.
...
grego, ao ucraniano e às duas formas escritas do chinês.

Aqueles 49 nomes são a parte que interessa. Quase todas as escolas do template
lá estão porque alguém que tinha a sua própria tese para escrever se sentou
...
oficialmente não ia — uma escola que não suportamos, um regulamento que nunca
vimos. É para isso que serve a licença, e é um bom destino para ela.

## Se quiseres acrescentar ao número

A coisa mais útil que podes fazer não é uma estrela.

* **Falta a tua escola?** Abre um
  [*issue* "New school"](https://github.com/joaomlourenco/novathesis/issues/new?template=request-to-support-a-new-school.md)
...
A todos os que abriram um *issue*, enviaram um *pull request*, corrigiram uma
tradução ou simplesmente disseram a um colega que isto existe: obrigado. O
número é mais vosso do que meu.
